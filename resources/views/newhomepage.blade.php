...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('skypeg-newhome/assets/favicon.ico') }}" />
    ...
    <link href="{{ asset('skypeg-newhome/css/styles.css') }}" rel="stylesheet" />
</head>

<body>
    <!-- Background Video-->
    <video class="bg-video" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
        <source src="{{ asset('skypeg-newhome/assets/mp4/bg.mp4') }}" type="video/mp4" />
    </video>
    <!-- Masthead-->
    <div class="masthead">
    ...
    <div class="social-icons">
        <div class="d-flex flex-row flex-lg-column justify-content-center align-items-center h-100 mt-3 mt-lg-0">
            <a class="btn btn-dark m-3"
                href="https://api.whatsapp.com/send?phone=6281214400997&app=facebook&entry_point=page_cta"><i
                    class="fab fa-whatsapp"></i></a>
            <a class="btn btn-dark m-3" href="https://www.facebook.com/SekolahKristenYahya/"><i

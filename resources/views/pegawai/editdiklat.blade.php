                ...
                <form action="/pegawai/diklat/edit/{{ $diklat->id_diklat }}" method="POST">
                    ...
                    <div class="form-row mt-2">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_diklat" value="{{ $diklat->nama_diklat }}"
                                class="form-control">
                            <!-- form group -->
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="jenis_diklat" class="form-control">
                                @foreach ($diklat1 as $dikl2)
                                    <option value="{{ $dikl2->kode_diklat }}"
                                        @if ($dikl2->kode_diklat == $diklat->kode_diklat) selected @endif>{{ $dikl2->jenis_diklat }}
                                    </option>
                                @endforeach
                            </select>
                            <!-- form group -->
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="nmr_sertifikat" value="{{ $diklat->no_sertifikat }}"
                                class="form-control">
                            <!-- form group -->
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="thn_sertifikat" value="{{ $diklat->thn_sertifikat }}"
                                class="form-control">
                            <!-- form group -->
                        </div>
                        <!-- form row -->
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="penyelenggara" value="{{ $diklat->penyelenggara }}"
                                class="form-control">
                            <!-- form group -->
                        </div>
                        <!-- form row -->
